...
public class LeavetypeController {
    ...
    public Result findAll(){
        ...
        return new Result(true, StatusCode.OK,"查询成功",leavetypeList) ;
    }
    ...
    public Result findById(@PathVariable Integer id){
        ...
        return new Result(true,StatusCode.OK,"查询成功",leavetype);
    }
     ...
     */
    @PutMapping(value="/{id}")
    public Result update(@RequestBody Leavetype leavetype,@PathVariable Integer id){
        leavetype.setId(id);
    ...
    public Result findList(@RequestParam Map searchMap){
        List<Leavetype> list = leavetypeService.findList(searchMap);
    ...
    public Result findPage(@RequestParam Map searchMap, @PathVariable  int page, @PathVariable  int size){
        Page<Leavetype> pageList = leavetypeService.findPage(searchMap, page, size);
