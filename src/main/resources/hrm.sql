CREATE TABLE `tb_department` (
  ...
  `status` int(11) DEFAULT NULL COMMENT '状态：0为禁用，1为启用',
  ...
  CONSTRAINT `tb_department_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `tb_department` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `tb_employee` (
  ...
  `job_id` int(11) DEFAULT NULL COMMENT '职位编码',
  ...
  KEY `pid` (`pid`),
  KEY `job_id` (`job_id`),
  CONSTRAINT `tb_employee_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `tb_employee` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `tb_organization` (
  ...
  UNIQUE KEY `code` (`code`) USING BTREE,
  KEY `pid` (`pid`),
  CONSTRAINT `tb_organization_ibfk_1` FOREIGN KEY (`pid`) REFERENCES `tb_organization` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
